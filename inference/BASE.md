...
- Without post-processing, my model scores were: Public 0.837 / Private 0.820.
...
| ------ | --------- | ---------- |
| No pseudo / No post-proc | 0.837 | 0.820 |
| With pseudo / No post-proc | 0.840 | 0.832 |
| No pseudo / With post-proc | 0.849 | 0.836 |
| With pseudo / With post-proc | 0.855 | 0.837 |

> Thanks to the organizers and hosts for an interesting competition, and to the community for insightful discussions and notebooks.
